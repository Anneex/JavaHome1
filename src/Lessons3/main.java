...
public class main {
    ...
    public static void main(String[] args) {
        Store store = new Store();
            store.setProductsList(new Product("car", 55, "toys", "red"));
            store.setProductsList(new Product("carSil", 12, "toys", "silver"));

//            store.removeProduct("carSil");
//            store.addPrice("car");
//            store.premiumGoods(11);
//            store.scoreType("toys");
        store.argProduct();
    }
}
